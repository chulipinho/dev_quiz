...
TextStyle get _selectedAppTextStyleRight => isRight? AppTextStyles.bodyDarkGreen : AppTextStyles.bodyDarkRed;
        ...
        child: Row(
          ...
          children: [
            Expanded(
              child: Text(
                title,
                style: isSelected ? _selectedAppTextStyleRight : AppTextStyles.body,
              ),
            ),
            Container(
              height: 24,
